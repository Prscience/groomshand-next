...
const products = [
  {
    ...
    bgGradient: "linear-gradient(135deg, #fff5eb 0%, #ffecd6 100%)",
  ...
  },
  {
    ...
    badgeColor: "var(--color-primary)",
    bgGradient: "linear-gradient(135deg, #e8f0ff 0%, #d6e4ff 100%)",
  ...
  },
  {
    ...
    bgGradient: "linear-gradient(135deg, #e8f8f5 0%, #d6f0ec 100%)",
